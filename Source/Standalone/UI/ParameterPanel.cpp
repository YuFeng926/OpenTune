...
ParameterPanel::ParameterPanel()
{
    ...
    setupHeader(pitchCorrectionHeader_, "Pitch correction");
    addAndMakeVisible(pitchCorrectionHeader_);

    setupLabel(retuneSpeedLabel_, "Retune Speed");
    ...
    setupLabel(vibratoDepthLabel_, "Vib. Depth");
    ...
    setupLabel(vibratoRateLabel_, "Vib. Rate");
    ...
    setupLabel(noteSplitLabel_, "Note Split");
    ...
    setupHeader(toolsHeader_, "Tools");
    addAndMakeVisible(toolsHeader_);

    autoTuneToolButton_ = std::make_unique<ToolIconButton>(0, "Auto", "Auto (A)");
    ...
    selectToolButton_ = std::make_unique<ToolIconButton>(1, "Select", "Select (Default)");
    ...
    drawNoteToolButton_ = std::make_unique<ToolIconButton>(2, "DrawNote", "Draw notes (N)");
    ...
    lineAnchorToolButton_ = std::make_unique<ToolIconButton>(3, "LineAnchor", "Line anchor (4)");
    ...
    handDrawToolButton_ = std::make_unique<ToolIconButton>(4, "HandDraw", "Hand draw pitch");
