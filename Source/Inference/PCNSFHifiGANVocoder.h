...
class PCNSFHifiGANVocoder : public IVocoder {
public:
    ...
    VocoderType getModelType() const override { return VocoderType::PC_NSF_HifiGAN; }
    std::string getName() const override { return "PC-NSF-HifiGAN (Pitch Controllable)"; }
    bool requiresMel() const override { return true; }
    size_t getModelSize() const override { return 50 * 1024 * 1024; }
